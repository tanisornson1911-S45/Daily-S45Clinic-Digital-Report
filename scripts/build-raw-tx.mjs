...
const SURGERY_MAP = {
  ...
  "Eye": "other",
  "ตัดถุงใต้ตา": "other", // หัตถการตา เช่นเดียวกับ "Eye" ด้านบน — พบ 2026-08-31 ว่าเคสนี้เคยถูกข้ามไปเงียบๆ
                            // (surgery ไม่อยู่ใน SURGERY_MAP) ทำให้ยอดขาย/มัดจำของหมอเป็ดขาดไป 1 เคส
  "ถอดพัก": "other",
  "Forehead": "other",
  "Ultera": "other",
